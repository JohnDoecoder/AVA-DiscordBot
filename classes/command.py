...
# DONE
class Command:
    def __init__(self, name: str, aliases: list, description: str, permissions: list, replies: list, urls: list):
        self.name = name
    ...
    def __repr__(self) -> str:
        return '<Command - name = ' + str(self.name) + ' description = ' + str(self.description) + ' >'
